...
double Ptr2Handle (void *ptr);
// construct a double value from a pointer that can be passed to Matlab
// as a handle

void *Handle2Ptr (double handle);
// extract pointer from a double handle
