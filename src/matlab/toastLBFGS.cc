// =========================================================================
// toastLBFGS
// MATLAB MEX wrapper for L-BFGS solver.
// Uses the liblbfgs-1.6 library
// The callback function for evaluating the gradient of the objective
// function can be provided as a Matlab function handle
// =========================================================================
