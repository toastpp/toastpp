...
template<>
void TDenseMatrix<double>::Ax (const TVector<double> &x, TVector<double> &b)
    const
{
...
#ifdef USE_BLAS_LEVEL2 // interface to BLAS level 2 xGEMV functions
template<>
void TDenseMatrix<double>::ATx (const TVector<double> &x, TVector<double> &b)
    const
{
...
template<>
void TDenseMatrix<double>::AB (const TDenseMatrix<double> &A,
...
template<>
void TDenseMatrix<float>::AB (const TDenseMatrix<float> &A,
...
template<>
void TDenseMatrix<toast::complex>::AB (const TDenseMatrix<toast::complex> &A,
...
template<>
TSymMatrix<double> ATA (const TDenseMatrix<double> &A)
{
...
template<>
TSymMatrix<float> ATA (const TDenseMatrix<float> &A)
{
    static char uplo = 'U';  // return result in upper triangle
    static char trans = 'N'; // 'N' actually indicates AAT, but since fortran
                             // stores in column format, all matrices are
...
template<>
TSymMatrix<toast::complex> ATA (const TDenseMatrix<toast::complex> &A)
{
    static char uplo = 'U';  // return result in upper triangle
    static char trans = 'N'; // 'N' actually indicates AAT, but since fortran
                             // stores in column format, all matrices are
...
#ifdef USE_BLAS_LEVEL3 // interface to BLAS level 3 xSYRK functions
template<>
TSymMatrix<double> AAT (const TDenseMatrix<double> &A)
{
    static char uplo = 'U';  // return result in upper triangle
...
template<>
TSymMatrix<float> AAT (const TDenseMatrix<float> &A)
{
    static char uplo = 'U';  // return result in upper triangle
    static char trans = 'T'; // 'T' actually indicates ATA, but since fortran
                             // stores in column format, all matrices are
...
template<>
TSymMatrix<toast::complex> AAT (const TDenseMatrix<toast::complex> &A)
{
    static char uplo = 'U';  // return result in upper triangle
    static char trans = 'T'; // 'T' actually indicates ATA, but since fortran
                             // stores in column format, all matrices are
...
template<class MT>
istream &operator>> (istream &is, TDenseMatrix<MT> &m)
{
    int i, n;
    char c;
    struct vectag {
...
template<class MT>
ostream &operator<< (ostream &os, const TDenseMatrix<MT> &m)
{
    os << '[';
