...
template MATHLIB int PCG (const FMatrix &A, const FVector &b, FVector &x,
    double &tol, const FPreconditioner *precon, int maxit);
template MATHLIB int PCG (const RMatrix &A, const RVector &b, RVector &x,
