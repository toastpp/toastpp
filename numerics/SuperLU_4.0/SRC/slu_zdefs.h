// MS 100616: All exported functions have been renamed to avoid a
...
extern void
toast_zgssv(superlu_options_t *, SuperMatrix *, int *, int *, SuperMatrix *,
      SuperMatrix *, SuperMatrix *, SuperLUStat_t *, int *);
extern void
toast_zgssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *,
    ...
    /* ILU */
extern void
toast_zgsisv(superlu_options_t *, SuperMatrix *, int *, int *, SuperMatrix *,
      SuperMatrix *, SuperMatrix *, SuperLUStat_t *, int *);
extern void
toast_zgsisx(superlu_options_t *, SuperMatrix *, int *, int *, int *,
       char *, double *, double *, SuperMatrix *, SuperMatrix *,
...
extern void
toast_zCreate_CompRow_Matrix(SuperMatrix *, int, int, int, doublecomplex *,
		       int *, int *, Stype_t, Dtype_t, Mtype_t);
extern void
...
extern void    toast_zFillRHS (trans_t, int, doublecomplex *, int, SuperMatrix *,
			  SuperMatrix *);
extern void    toast_zgstrs (trans_t, SuperMatrix *, SuperMatrix *, int *, int *,
                        SuperMatrix *, SuperLUStat_t*, int *);
/* ILU */
extern void    toast_zgsitrf (superlu_options_t*, SuperMatrix*, int, int, int*,
		        void *, int, int *, int *, SuperMatrix *, SuperMatrix *,
                        SuperLUStat_t*, int *);
extern int     toast_zldperm(int, int, int, int [], int [], doublecomplex [],
                        int [],	double [], double []);
extern int     toast_ilu_zsnode_dfs (const int, const int, const int *, const int *,
			       const int *, int *, GlobalLU_t *);
extern void    toast_ilu_zpanel_dfs (const int, const int, const int, SuperMatrix *,
			       int *, int *, doublecomplex *, double *, int *, int *,
			       int *, int *, int *, int *, GlobalLU_t *);
extern int     toast_ilu_zcolumn_dfs (const int, const int, int *, int *, int *,
				int *, int *, int *, int *, int *,
				GlobalLU_t *);
extern int     toast_ilu_zcopy_to_ucol (int, int, int *, int *, int *,
                                  doublecomplex *, int, milu_t, double, int,
                                  doublecomplex *, int *, GlobalLU_t *, int *);
extern int     toast_ilu_zpivotL (const int, const double, int *, int *, int, int *,
			    int *, int *, int *, double, milu_t,
                            doublecomplex, GlobalLU_t *, SuperLUStat_t*);
extern int     toast_ilu_zdrop_row (superlu_options_t *, int, int, double,
...
extern void    toast_zgsrfs (trans_t, SuperMatrix *, SuperMatrix *,
...
extern int     toast_zLUMemInit (fact_t, void *, int, int, int, int, int,
                            double, SuperMatrix *, SuperMatrix *,
...
extern int     toast_zQuerySpace (SuperMatrix *, SuperMatrix *, mem_usage_t *);
extern int     toast_ilu_zQuerySpace (SuperMatrix *, SuperMatrix *, mem_usage_t *);

/*! \brief Auxiliary routines */
extern void    toast_zreadhb(int *, int *, int *, doublecomplex **, int **, int **);
extern void    toast_zreadrb(int *, int *, int *, doublecomplex **, int **, int **);
extern void    toast_zreadtriple(int *, int *, int *, doublecomplex **, int **, int **);
...
extern void    toast_zprint_lu_col(char *, int, int, int *, GlobalLU_t *);
extern int     toast_print_double_vec(char *, int, double *);
