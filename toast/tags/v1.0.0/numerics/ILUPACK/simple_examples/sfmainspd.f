...
c              SSPDAMGinit         init default parameter  
c              SSPDAMGfactor       compute multilevel ILU `PREC'
c              SSPDAMGsol          solve a single linear system with `PREC'
c              SSPDAMGsolver       solve linear system Ax=b iteratively
c                                  using the ILUPACK preconditioner
c              SSPDAMGdelete       release memory
c              SSPDAMGnnz          logical number of nonzero entries of ILU
c              SSPDAMGinfo         display multilevel structure
c
      integer  SSPDAMGfactor, SSPDAMGsolver, SSPDAMGnnz
      external SSPDAMGinit,   SSPDAMGsol, SSPDAMGdelete,
     +         SSPDAMGfactor, SSPDAMGsolver,
     +         SSPDAMGnnz, SSPDAMGinfo
c
...
c     init default parameters  
      call SSPDAMGinit(n,ia,ja,a,matching,ordering,
...
c     nrestart=20
c
c     ignored for single precision drivers
c     mixedprecision=1
c
...
c     solve a single linear system with `PREC'
      call SSPDAMGsol(param,PREC,rhs,sol,n)
c
...
c     solve Ax=b iteratively
      ierr=SSPDAMGsolver(param,PREC,rhs,sol,
     +                   n,ib,jb,b,matching,ordering,
     +                   droptol, droptolS, condest, restol,
     +                   maxit, elbow, lfil, lfilS, nrestart, 
     +                   mixedprecision, ind)
