...
c              CSYMAMGinit         init default parameter  
c              CSYMAMGfactor       compute multilevel ILU `PREC'
c              CSYMAMGsol          solve a single linear system with `PREC'
c              CSYMAMGsolver       solve linear system Ax=b iteratively
c                                  using the ILUPACK preconditioner
c              CSYMAMGdelete       release memory
c              CSYMAMGnnz          logical number of nonzero entries of ILU
c              CSYMAMGinfo         display multilevel structure
c
      integer  CSYMAMGfactor, CSYMAMGsolver, CSYMAMGnnz
      external CSYMAMGinit,   CSYMAMGsol, CSYMAMGdelete,
     +         CSYMAMGfactor, CSYMAMGsolver,
     +         CSYMAMGnnz,    CSYMAMGinfo
c
...
c     init default parameters  
      call CSYMAMGinit(n,ia,ja,a,matching,ordering,
...
c     solve a single linear system with `PREC'
      call CSYMAMGsol(param,PREC,rhs,sol,n)
c
...
c     solve Ax=b iteratively
      ierr=CSYMAMGsolver(param,PREC,rhs,sol,
     +                   n,ib,jb,b,matching,ordering,
     +                   droptol, droptolS, condest, restol,
     +                   maxit, elbow, lfil, lfilS, nrestart, 
     +                   mixedprecision, ind)
