      SUBROUTINE TBALPH (JL,JTMAX,NVB,ALPHA,TB) 
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    TBALPH inserts (ALPHA) into (TB)                                 *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*    ALPHA (ari) : matrix (Q')*(B)*(R) at step JL                     *
...
C
      ...
      DOUBLE PRECISION ALPHA(NVB,NVB),TB(JTMAX,0:NVB)
C
C==== local variables ==================================================
C
