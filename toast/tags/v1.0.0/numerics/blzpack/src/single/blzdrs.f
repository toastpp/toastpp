...
C*  - Purpose:                                                         *
C*                                                                     *
C*    BLZDRS is the user interface for a set of subprograms intended   *
...
C*             On the first call to BLZDRS, the first 15 entries of    *
...
C*             first call to BLZDRS, the first 4 entries of RSTOR must *
C*             contain:                                                *
C*                                                                     *
...
C
C............ BLZDRS is being called for the first time ................
C
