...
void genmat_sourcevalvector_cos_3D(RCompRowMatrix& Svec, const Mesh& mesh, const Mesh& S2mesh, const int Nsource);
...
void genmat_source_3D(RCompRowMatrix* & Source, const Mesh& mesh,  const Mesh& S2mesh, const int* Nsource, const int ns, const RCompRowMatrix& b1);
...
void calc_paramdistr_nobf_new_3D(RDenseMatrix*& sigma, RVector& sigmatot, RVector& intst, const Mesh& mesh, const RVector& muscat, const RVector& muabs, const RVector& g,const Mesh& S2mesh);
