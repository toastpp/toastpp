...
// ....................................................................
 ...
 for ( int f=0;f<NoVoxels;f++)
     ...
     // ....................................................................
     //Copy initialFaces to SurfaceFaces
     // ....................................................................
   
     int SurfaceFaces [6*NoVoxels][4];
	 ...
	 for(int ff=0;ff<4;ff++)
	   {
	     SurfaceFaces[rr][ff]=InitialFaces[rr][ff];
	   }
       }
	...
	if(InitialFaces[re][0]==InitialFaces[fe][0])
	  {
		...
		{
		  SurfaceFaces[fe][in]=-1;
		  SurfaceFaces[re][in]=-1;
		}
	      }
	    }
	  }
 ...
 for(int gy=0;gy<NoVoxels*6;gy++)
   {
     if(SurfaceFaces[gy][0]!=-1 || SurfaceFaces[gy][1]!=-1 || SurfaceFaces[gy][2]!=-1 || SurfaceFaces[gy][3]!=-1)
       {
	 LengoFaces++;
       }
   }
 ...
 // ....................................................................
 //     Makes a new array SurfaceFaces with the surface faces
 // ....................................................................
 ...
 for(int ga=0;ga<NoVoxels*6;ga++)
   {
     if(SurfaceFaces[ga][0]!=-1 ||  SurfaceFaces[ga][1]!=-1 || SurfaceFaces[ga][2]!=-1 || SurfaceFaces[ga][3]!=-1)
       {
	AntiClocFaces[LengoFaces][0]=SurfaceFaces[ga][0];
	AntiClocFaces[LengoFaces][1]=SurfaceFaces[ga][1];
	AntiClocFaces[LengoFaces][2]=SurfaceFaces[ga][2];
	AntiClocFaces[LengoFaces][3]=SurfaceFaces[ga][3];
	 LengoFaces++;
       }
   }
 ...
 if (li>0) 
   {
     ...
     // ..................................................................
     //     Creates map1 for the inside vertices
     // ....................................................................
     //for (int jj=0;jj<NoVRT;jj++)
     //  {
     //	 //jf=jj;
     //	 while( jj == TobeRemov[hh])
     //	   {
     //	     jf-=1;
     //	      hh++;
     //	      cout<<" hh= "<<hh<<"jf ="<<jf<<endl;
	      //	   }
	 ...
	 // hh++;
	 // map1[jj]=jj+hh;
     //	 cerr<< " to "<<jj<<" maps to "<<map1[jf]<<endl;
     //  }
  ...
  // ....................................................................
   ...
   // ....................................................................
     //     Printing The final surface lengo faces
     // ....................................................................   
