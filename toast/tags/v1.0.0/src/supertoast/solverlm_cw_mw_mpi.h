...
#ifndef __SOLVERLM_CW_MW_MPI_H
#define __SOLVERLM_CW_MW_MPI_H

#include "solver_cw_mw_mpi.h"
#include "of.h"

class SolverLM_CW_MW_MPI: public Solver_CW_MW_MPI {
public:
    SolverLM_CW_MW_MPI (ParamParser *_pp = NULL);
    ~SolverLM_CW_MW_MPI ();
