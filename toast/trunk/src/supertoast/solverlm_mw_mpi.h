...
#ifndef __SOLVERLM_MW_MPI_H
#define __SOLVERLM_MW_MPI_H

#include "solver_mw_mpi.h"
#include "of.h"

class SolverLM_MW_MPI: public Solver_MW_MPI {
public:
    SolverLM_MW_MPI (ParamParser *_pp = NULL);
    ~SolverLM_MW_MPI ();
