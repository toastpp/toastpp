function [] = generateInputFile_phys_precon(hMesh, fname, output_file_prefix, nQ, nM, specify_QM, source_types, source_profiles, source_widRadii,source_nodes, meas_profiles, meas_widRadii, meas_nodes, g, MHz_freq, is_cosine, directionVector, mua, mus, ref, hifi_sphOrder, lowfi_sphOrder)
...
%
%	hifi_sphOrder -> spherical harmonics order for each node number used for the system under consideration
%
%	lowfi_sphOrder -> spherical harmonics order for each node number to be used for computing the preconditioner
