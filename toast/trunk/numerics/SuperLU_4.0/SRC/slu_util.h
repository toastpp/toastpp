...
extern void    toast_Destroy_CompRow_Matrix(SuperMatrix *);
...
extern void    toast_set_default_options(superlu_options_t *options);
extern void    toast_ilu_set_default_options(superlu_options_t *options);
extern void    toast_sp_preorder (superlu_options_t *, SuperMatrix*, int*, int*,
			    SuperMatrix*);
