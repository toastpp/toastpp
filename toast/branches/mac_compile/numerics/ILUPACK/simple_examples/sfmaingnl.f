...
c              SGNLAMGinit         init default parameter  
c              SGNLAMGfactor       compute multilevel ILU `PREC'
c              SGNLAMGsol          solve a single linear system with `PREC'
c              SGNLAMGsolver       solve linear system Ax=b iteratively
c                                  using the ILUPACK preconditioner
c              SGNLAMGdelete       release memory
c              SGNLAMGnnz          logical number of nonzero entries of ILU
c              SGNLAMGinfo         display multilevel structure
c
      integer  SGNLAMGfactor, SGNLAMGsolver, SGNLAMGnnz
      external SGNLAMGinit,   SGNLAMGsol, SGNLAMGdelete,
     +         SGNLAMGfactor, SGNLAMGsolver,
     +         SGNLAMGnnz,    SGNLAMGinfo
c
...
c     init default parameters  
      call SGNLAMGinit(n,ia,ja,a,matching,ordering,
...
c     solve a single linear system with `PREC'
      call SGNLAMGsol(param,PREC,rhs,sol,n)
c
...
c     solve Ax=b iteratively
      ierr=SGNLAMGsolver(param,PREC,rhs,sol,
     +                   n,ib,jb,b,matching,ordering,
     +                   droptol, droptolS, condest, restol,
     +                   maxit, elbow, lfil, lfilS, nrestart, 
     +                   mixedprecision, ind)
