...
c              SSYMAMGinit         init default parameter  
c              SSYMAMGfactor       compute multilevel ILU `PREC'
c              SSYMAMGsol          solve a single linear system with `PREC'
c              SSYMAMGsolver       solve linear system Ax=b iteratively
c                                  using the ILUPACK preconditioner
c              SSYMAMGdelete       release memory
c              SSYMAMGnnz          logical number of nonzero entries of ILU
c              SSYMAMGinfo         display multilevel structure
c
      integer  SSYMAMGfactor, SSYMAMGsolver, SSYMAMGnnz
      external SSYMAMGinit,   SSYMAMGsol, SSYMAMGdelete,
     +         SSYMAMGfactor, SSYMAMGsolver,
     +         SSYMAMGnnz,    SSYMAMGinfo
c
...
c     init default parameters  
      call SSYMAMGinit(n,ia,ja,a,matching,ordering,
...
c     solve a single linear system with `PREC'
      call SSYMAMGsol(param,PREC,rhs,sol,n)
c
...
c     solve Ax=b iteratively
      ierr=SSYMAMGsolver(param,PREC,rhs,sol,
     +                   n,ib,jb,b,matching,ordering,
     +                   droptol, droptolS, condest, restol,
     +                   maxit, elbow, lfil, lfilS, nrestart, 
     +                   mixedprecision, ind)
