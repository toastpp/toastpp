...
C*                                                                     *
C*    Examples: files `drvgp4.dat', `A.dat' and `B2.dat'               *
C*    Factorization and solver used: MA47A , MA47B , MA47C , MA47I     *
C*    BLAS kernels used: SAXPY,SCOPY                                   *
C*                                                                     *
C***********************************************************************
C
C.... parameters .......................................................
...
C
     ...
     &                 N,NE,NNEIGB
      REAL             A(MAXA),B(MAXA),C(MAXA),CNTL(2),RINFO(4),W(LN)
...
C
              CALL SCOPY (NE,A,1,C,1)
              CALL SAXPY (NE,-SIGMA,B,1,C,1)
C
C............ factor (C)=(L)*(D)*(L') ..................................
C
              CALL MA47B  (N,NE,JCN,C,MAXA,IW1,MAXIW1,KEEP,
