...
CVector precond_setup (const CGenericSparseMatrix&, const CVector&);
CVector precond (const CGenericSparseMatrix&, const CVector&);
...
CVector precond (const CGenericSparseMatrix& AC,const CVector& y)
{
    int j, k, N = y.Dim();
