function [] = generateInputFile(hMesh, fname, output_file_prefix, nQ, nM, specify_QM, source_types, source_profiles, source_widRadii,source_nodes, meas_profiles, meas_widRadii, meas_nodes, g, MHz_freq, is_cosine, directionVector, mua, mus, ref, sphOrder)
