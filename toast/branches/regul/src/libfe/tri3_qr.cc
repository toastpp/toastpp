...
int Triangle3_qr::GlobalIntersection (const NodeList &nlist,
...
int Triangle3_qr::Intersection (const Point &p1, const Point &p2, Point **list)
{
    double xs, ys;
