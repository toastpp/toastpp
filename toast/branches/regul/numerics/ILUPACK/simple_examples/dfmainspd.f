...
c              DSPDAMGinit         init default parameter  
c              DSPDAMGfactor       compute multilevel ILU `PREC'
c              DSPDAMGsol          solve a single linear system with `PREC'
c              DSPDAMGsolver       solve linear system Ax=b iteratively
c                                  using the ILUPACK preconditioner
c              DSPDAMGdelete       release memory
c              DSPDAMGnnz          logical number of nonzero entries of ILU
c              DSPDAMGinfo         display multilevel structure
c
      integer  DSPDAMGfactor, DSPDAMGsolver, DSPDAMGnnz
      external DSPDAMGinit,   DSPDAMGsol, DSPDAMGdelete,
     +         DSPDAMGfactor, DSPDAMGsolver,
     +         DSPDAMGnnz, DSPDAMGinfo
c
...
c     init default parameters  
      call DSPDAMGinit(n,ia,ja,a,matching,ordering,
...
c     solve a single linear system with `PREC'
      call DSPDAMGsol(param,PREC,rhs,sol,n)
c
...
c     solve Ax=b iteratively
      ierr=DSPDAMGsolver(param,PREC,rhs,sol,
     +                   n,ib,jb,b,matching,ordering,
     +                   droptol, droptolS, condest, restol,
     +                   maxit, elbow, lfil, lfilS, nrestart, 
     +                   mixedprecision, ind)
