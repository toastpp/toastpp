...
c              ZSYMAMGinit         init default parameter  
c              ZSYMAMGfactor       compute multilevel ILU `PREC'
c              ZSYMAMGsol          solve a single linear system with `PREC'
c              ZSYMAMGsolver       solve linear system Ax=b iteratively
c                                  using the ILUPACK preconditioner
c              ZSYMAMGdelete       release memory
c              ZSYMAMGnnz          logical number of nonzero entries of ILU
c              ZSYMAMGinfo         display multilevel structure
c
      integer  ZSYMAMGfactor, ZSYMAMGsolver, ZSYMAMGnnz
      external ZSYMAMGinit,   ZSYMAMGsol, ZSYMAMGdelete,
     +         ZSYMAMGfactor, ZSYMAMGsolver,
     +         ZSYMAMGnnz,    ZSYMAMGinfo
c
...
c     init default parameters  
      call ZSYMAMGinit(n,ia,ja,a,matching,ordering,
...
c     solve a single linear system with `PREC'
      call ZSYMAMGsol(param,PREC,rhs,sol,n)
c
...
c     solve Ax=b iteratively
      ierr=ZSYMAMGsolver(param,PREC,rhs,sol,
     +                   n,ib,jb,b,matching,ordering,
     +                   droptol, droptolS, condest, restol,
     +                   maxit, elbow, lfil, lfilS, nrestart, 
     +                   mixedprecision, ind)
