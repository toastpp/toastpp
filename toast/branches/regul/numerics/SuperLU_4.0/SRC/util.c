 ...
 */
void toast_set_default_options(superlu_options_t *options)
{
    options->Fact = DOFACT;
    options->Equil = YES;
 ...
 */
void toast_ilu_set_default_options(superlu_options_t *options)
{
...
void
toast_Destroy_CompRow_Matrix(SuperMatrix *A)
{
