/* mc64ad.f -- translated by f2c (version 20060506).
...
/* ********************************************************************** */
/* Subroutine */ int mc64id_(integer *icntl)
{
    static integer i__;
...
/* ********************************************************************** */
/* Subroutine */ int mc64ad_(integer *job, integer *n, integer *ne, integer *
	ip, integer *irn, doublereal *a, integer *num, integer *cperm, 
	integer *liw, integer *iw, integer *ldw, doublereal *dw, integer *
	icntl, integer *info)
{
    /* Format strings */
    ...
    static doublereal fact, rinf;
    extern /* Subroutine */ int mc21ad_(integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *), mc64bd_(
	    integer *, integer *, integer *, integer *, doublereal *, integer 
	    *, integer *, integer *, integer *, integer *, integer *, 
	    doublereal *), mc64rd_(integer *, integer *, integer *, integer *,
	     doublereal *), mc64sd_(integer *, integer *, integer *, integer *
	    , doublereal *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *), mc64wd_(
	    integer *, integer *, integer *, integer *, doublereal *, integer 
    ...
    /* Fortran I/O blocks */
    static cilist io___3 = { 0, 0, 0, fmt_9001, 0 };
    static cilist io___4 = { 0, 0, 0, fmt_9001, 0 };
    static cilist io___5 = { 0, 0, 0, fmt_9001, 0 };
    static cilist io___7 = { 0, 0, 0, fmt_9004, 0 };
    static cilist io___8 = { 0, 0, 0, fmt_9005, 0 };
    static cilist io___11 = { 0, 0, 0, fmt_9006, 0 };
    static cilist io___12 = { 0, 0, 0, fmt_9007, 0 };
    static cilist io___13 = { 0, 0, 0, fmt_9020, 0 };
    static cilist io___14 = { 0, 0, 0, fmt_9021, 0 };
    static cilist io___15 = { 0, 0, 0, fmt_9022, 0 };
    static cilist io___16 = { 0, 0, 0, fmt_9023, 0 };
    static cilist io___18 = { 0, 0, 0, fmt_9011, 0 };
    static cilist io___19 = { 0, 0, 0, fmt_9012, 0 };
    static cilist io___20 = { 0, 0, 0, fmt_9030, 0 };
    static cilist io___21 = { 0, 0, 0, fmt_9031, 0 };
    static cilist io___22 = { 0, 0, 0, fmt_9032, 0 };
    static cilist io___23 = { 0, 0, 0, fmt_9033, 0 };
    static cilist io___24 = { 0, 0, 0, fmt_9034, 0 };
...
/* JOB is an INTEGER variable which must be set by the user to */
...
/* CPERM is an INTEGER array of length N that need not be set by the */
...
/* ICNTL is an INTEGER array of length 10. Its components control the */
...
/* INFO is an INTEGER array of length 10 which need not be set by the */
...
/* XSL    RINF = FD05AD(5) */
    ...
    /* Function Body */
    rinf = dlamch_("Overflow", (ftnlen)8);
/* Check value of JOB */
    if (*job < 1 || *job > 5) {
	info[1] = -1;
	info[2] = *job;
	if (icntl[1] >= 0) {
	    io___3.ciunit = icntl[1];
	    s_wsfe(&io___3);
	    do_fio(&c__1, (char *)&info[1], (ftnlen)sizeof(integer));
	    do_fio(&c__1, "JOB", (ftnlen)3);
...
/* Print diagnostics on input */
	...
	i__1 = *n + 1;
	for (j = 1; j <= i__1; ++j) {
	    do_fio(&c__1, (char *)&ip[j], (ftnlen)sizeof(integer));
	}
	e_wsfe();
	...
	i__1 = *ne;
	for (j = 1; j <= i__1; ++j) {
	    do_fio(&c__1, (char *)&irn[j], (ftnlen)sizeof(integer));
	}
	e_wsfe();
	if (*job > 1) {
...
/* Print diagnostics on output */
	...
	s_wsfe(&io___20);
	for (j = 1; j <= 2; ++j) {
	    do_fio(&c__1, (char *)&info[j], (ftnlen)sizeof(integer));
	}
	e_wsfe();
	...
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    do_fio(&c__1, (char *)&cperm[j], (ftnlen)sizeof(integer));
	}
	e_wsfe();
	if (*job == 5) {
	    io___23.ciunit = icntl[3];
	    s_wsfe(&io___23);
	    i__1 = *n;
	    for (j = 1; j <= i__1; ++j) {
		do_fio(&c__1, (char *)&dw[j], (ftnlen)sizeof(doublereal));
	    }
	    e_wsfe();
	    io___24.ciunit = icntl[3];
	    s_wsfe(&io___24);
	    i__1 = *n;
	    for (j = 1; j <= i__1; ++j) {
		do_fio(&c__1, (char *)&dw[*n + j], (ftnlen)sizeof(doublereal))
			;
	    }
	    e_wsfe();
	}
...
/* ********************************************************************** */
/* Subroutine */ int mc64bd_(integer *n, integer *ne, integer *ip, integer *
	irn, doublereal *a, integer *iperm, integer *num, integer *jperm, 
	integer *pr, integer *q, integer *l, doublereal *d__)
{
    /* System generated locals */
    ...
    static integer i0, q0;
    static doublereal ai, di;
    static integer ii, jj, kk;
    static doublereal bv;
    static integer up;
    static doublereal dq0;
    static integer kk1, kk2;
    static doublereal csp;
    static integer isp, jsp, low;
    static doublereal dnew;
    static integer jord, qlen, idum, jdum;
    static doublereal rinf;
    extern /* Subroutine */ int mc64dd_(integer *, integer *, integer *, 
	    doublereal *, integer *, integer *), mc64ed_(integer *, integer *,
	     integer *, doublereal *, integer *, integer *), mc64fd_(integer *
...
/* IPERM is an INTEGER array of length N. On exit, it contains the */
...
/* IW is an INTEGER work array of length 4N. */
...
/* ********************************************************************** */
/* Subroutine */ int mc64dd_(integer *i__, integer *n, integer *q, doublereal 
	*d__, integer *l, integer *iway)
{
    /* System generated locals */
    integer i__1;
    ...
    static integer qk, pos, idum, posk;
...
/* ********************************************************************** */
/* Subroutine */ int mc64ed_(integer *qlen, integer *n, integer *q, 
	doublereal *d__, integer *l, integer *iway)
{
    /* System generated locals */
    integer i__1;
    ...
    /* Local variables */
    static integer i__;
    static doublereal di, dk, dr;
    static integer pos, idum, posk;
...
/* ********************************************************************** */
/* Subroutine */ int mc64fd_(integer *pos0, integer *qlen, integer *n, 
	integer *q, doublereal *d__, integer *l, integer *iway)
{
    /* System generated locals */
    integer i__1;
...
/* ********************************************************************** */
/* Subroutine */ int mc64rd_(integer *n, integer *ne, integer *ip, integer *
	irn, doublereal *a)
{
    /* System generated locals */
    integer i__1, i__2, i__3;
    ...
    /* Local variables */
    static integer j, k, r__, s;
    static doublereal ha;
    static integer hi, td, mid, len, ipj;
    static doublereal key;
    static integer last, todo[50], first;
...
/* ********************************************************************** */
/* Subroutine */ int mc64sd_(integer *n, integer *ne, integer *ip, integer *
	irn, doublereal *a, integer *iperm, integer *numx, integer *w, 
	integer *len, integer *lenl, integer *lenh, integer *fc, integer *iw, 
	integer *iw4)
{
    /* System generated locals */
    ...
    /* Local variables */
    static integer i__, j, k, l, ii, mod, cnt, num;
    static doublereal bval, bmin, bmax, rinf;
    static integer nval, wlen, idum1, idum2, idum3;
    extern /* Subroutine */ int mc64qd_(integer *, integer *, integer *, 
	    integer *, integer *, doublereal *, integer *, doublereal *), 
	    mc64ud_(integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
...
/* IW is an INTEGER work array of length 10N. */
...
/* IW is integer work array of length N. */
/* IW4 is integer work array of length 4N used by MC64U/UD. */
...
/* ********************************************************************** */
/* Subroutine */ int mc64qd_(integer *ip, integer *lenl, integer *lenh, 
	integer *w, integer *wlen, doublereal *a, integer *nval, doublereal *
	val)
{
    /* System generated locals */
    integer i__1, i__2, i__3;
    ...
    /* Local variables */
    static integer j, k, s;
    static doublereal ha;
    static integer ii, pos;
    static doublereal split[10];
...
/* ********************************************************************** */
/* Subroutine */ int mc64ud_(integer *id, integer *mod, integer *n, integer *
	irn, integer *lirn, integer *ip, integer *lenc, integer *fc, integer *
	iperm, integer *num, integer *numx, integer *pr, integer *arp, 
	integer *cv, integer *out)
{
    ...
    /* Local variables */
    static integer i__, j, k, j1, ii, kk, id0, id1, in1, in2, nfc, num0, num1,
	     num2, jord, last;
...
/* ********************************************************************** */
/* Subroutine */ int mc64wd_(integer *n, integer *ne, integer *ip, integer *
	irn, doublereal *a, integer *iperm, integer *num, integer *jperm, 
	integer *out, integer *pr, integer *q, integer *l, doublereal *u, 
	doublereal *d__)
{
    /* System generated locals */
    integer i__1, i__2, i__3;
    ...
    /* Local variables */
    static integer i__, j, k, i0, k0, k1, k2, q0;
    static doublereal di;
    static integer ii, jj, kk;
    ...
    static doublereal csp;
    static integer isp, jsp, low;
    static doublereal dmin__, dnew;
    static integer jord, qlen, jdum;
    static doublereal rinf;
    extern /* Subroutine */ int mc64dd_(integer *, integer *, integer *, 
	    doublereal *, integer *, integer *), mc64ed_(integer *, integer *,
	     integer *, doublereal *, integer *, integer *), mc64fd_(integer *
...
/* IW is an INTEGER work array of length 5N. */
